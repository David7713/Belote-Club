...
const Main = () => {
 ...
 <div className="section footer">   
    <div className='footerContent'>
        ...
        <p className='footerParagraphText'>Play Anytime, Anywhere: No need to wait for a card-playing partner or gather a group of friends. Our app allows you<br></br> to enjoy Belote whenever and wherever you want,right from the palm of your hand.</p>
     <div className='linksSection'>
          <a href="https://t.me/BeloteClub" target="_blank"> <div className='telegram'></div> </a>
         <div className='socialMedia'>
          <a href="#"><div className='appStore'> </div></a>
